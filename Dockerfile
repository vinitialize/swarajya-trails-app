...
ARG FIREBASE_AUTH_DOMAIN=swarajyatrails.run.place
...
RUN echo "=== API Keys Debug Info ===" && \
    ...
    echo "Google Maps API key: ${GOOGLE_MAPS_API_KEY:+YES} (length: ${#GOOGLE_MAPS_API_KEY})" && \
    ...
    echo "VITE_GOOGLE_MAPS_API_KEY: ${VITE_GOOGLE_MAPS_API_KEY:+YES} (length: ${#VITE_GOOGLE_MAPS_API_KEY})" && \
